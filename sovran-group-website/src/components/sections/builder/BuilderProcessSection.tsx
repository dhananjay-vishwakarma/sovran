    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white" id="process">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl text-[#081E27] mb-4">Our Process & Approach</h2>
        ...
        <div className="mt-16 bg-gray-100 p-8 rounded-lg">
          <h3 className="text-2xl text-center text-[#081E27] mb-8">Our Approach to Quality Construction</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-lg text-[#081E27] mb-2">Quality Assurance</h4>
              <p className="text-dark-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-lg text-[#081E27] mb-2">Expert Craftsmen</h4>
              <p className="text-dark-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-lg text-[#081E27] mb-2">On-Time Delivery</h4>
              <p className="text-dark-700">
