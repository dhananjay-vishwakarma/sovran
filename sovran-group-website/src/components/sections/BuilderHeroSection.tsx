...
const BuilderHeroSection: React.FC = () => {
  return (
    <section className="relative h-screen flex items-center bg-[#081E27]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="mb-8">
          <button className="bg-primary-500 hover:bg-primary-600 text-[#081E27]  py-4 px-8 rounded-lg text-lg transition-all">
            Book Consultation Now
          </button>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mt-8">
          <div className="bg-[#081E27]/60 backdrop-blur-sm px-6 py-3 rounded-full shadow-md">
