    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-100">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl  text-[#081E27] mb-4">Frequently Asked Questions</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl  text-[#081E27] mb-3">How long does a typical home renovation take?</h3>
          ...
          {/* FAQ Item 2 */}
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl  text-[#081E27] mb-3">Do you handle all the necessary permits and approvals?</h3>
            <p className="text-dark-700">
          ...
          {/* FAQ Item 3 */}
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl  text-[#081E27] mb-3">How do you ensure quality control throughout the project?</h3>
            <p className="text-dark-700">
          ...
          {/* FAQ Item 4 */}
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl  text-[#081E27] mb-3">Can you work with my existing architect's plans?</h3>
            <p className="text-dark-700">
          ...
          {/* FAQ Item 5 */}
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl  text-[#081E27] mb-3">What warranties and guarantees do you offer?</h3>
            <p className="text-dark-700">
